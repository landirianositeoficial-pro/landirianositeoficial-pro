...
### 🛠️ Mi Stack Tecnológico & Herramientas

#### **Desarrollo Web & Lógica**
* **Frontend:** HTML5, CSS3 (Styling), JavaScript
* **Backend & Automatización:** Python
* **Control de Versiones:** Git & GitHub

#### **E-Commerce & Finanzas Digitales**
* **Plataformas:** Creación de tiendas online, Pasarelas de pago, Marketplace
* **Pasarelas de Pago:** Integración de Binance Pay, AirTM, procesamiento local
* **Atención Automatizada:** Bots de Telegram, Chatbots de atención al cliente

#### **Herramientas de Auditoría, IA y Marketing**
* **Calidad & SEO:** Auditoría técnica web con W3C Validator
* **IA Avanzada:** Implementación y desarrollo de prompts con Claude y Antigravity
* **Growth Hacking:** Creación de perfiles digitales, diseño en Canva y optimización de algoritmos para viralidad en redes
